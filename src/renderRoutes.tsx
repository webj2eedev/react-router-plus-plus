        ...
        return <Redirect exact={exact} strict={strict} from={path} to={redirect}/>;
            ...
            if(route.routes){
                return (
                            ...
                            sensitive={sensitive}
                            path={path}
                            render={(routeComponentProps: RouteComponentProps<any>) => {                                //Route里面应该渲染render里的东西
                                return <CustomRouteComponent route={route} routeComponentProps={routeComponentProps}/>
                            }}
                            />
                    )
                }else{
                    return (
                            ...
                            <Route
                                ...
                                path={path}
                                render={(routeComponentProps: RouteComponentProps<any>) => {                                //Route里面应该渲染render里的东西
                                    return <ErrorBoundary><CustomRouteComponent route={route} routeComponentProps={routeComponentProps}/></ErrorBoundary>
                                }}
                            />
